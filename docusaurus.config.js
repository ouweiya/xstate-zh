...
const config = {
  title: 'Stately',
  tagline: 'Stately 的文档和博客：现代 Web 的状态机和状态图表',
  ...
  projectName: 'xstate-zh', // Usually your repo name.
