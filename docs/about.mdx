---
title: Stately + XState 文档
slug: '/'
hide_title: true
---

## 欢迎来到 Stately 和 XState 文档

[Stately.ai](studio.mdx) 是一个可视化软件建模平台，用于将您的应用程序和业务逻辑建模为状态机/状态图和演员，并且可以扩展到任何复杂程度。
...
<div className="docs-intro">
    ...
    <p><a href="./docs/xstate">XState</a> 是一个顶级的开源库，用于在 JavaScript 和 TypeScript 应用程序中编排和管理状态。</p>
</div>
...
<ul className="content-boxes">
  <li>
    <a className="link-box" href="./docs/states">
      <RocketIcon size="40" />
      <strong>开始使用</strong>
      <p>直接学习如何使用 Stately Studio 编辑器，从状态开始。</p>
    </a>
  </li>
  <li>
    <a className="link-box" href="./docs/studio">
      <LayoutIcon size="40"/>
      <strong>Stately Studio 概述</strong>
      <p>了解更多关于 Stately Studio 的可视化编辑器以及如何使用 Stately Studio 的高级功能与团队协作。</p>
    </a>
  </li>
  <li>
    <a className="link-box" href="./docs/state-machines-and-statecharts">
      <BookOpenTextIcon size="40"/>
      <strong>学习状态机和状态图</strong>
      <p>通过我们的无代码介绍。</p>
    </a>
  </li>
  <li>
    <a className="link-box" href="./docs/xstate">
      <CodeIcon size="40"/>
      <strong>学习 XState</strong>
      <p>通过我们的 JavaScript 和 TypeScript 库开始学习状态机和状态图。</p>
    </a>
  </li>
</ul>
...
## Stately Studio 还是 XState？

Stately Studio 和 XState 在一起使用时最强大。使用 Stately Studio 的可视化编辑器协作建模您的应用程序逻辑，并使用 XState 将该逻辑集成到您的代码库中。

您也可以在没有 Stately Studio 的情况下在代码库中使用 XState，如果您还不熟悉 XState，欢迎使用 Stately Studio。

## 谁是 Stately？

![Stately 团队，包括 Gavin、Farzad、David、Mateusz、Jenny、Laura、Anders、Nick 和 Kevin，所有人都站在车库门前，互相笑着。](/stately.png)

我们是 [Stately](https://stately.ai)，一个由 [David Khourshid](https://twitter.com/davidkpiano) 创立的小团队，David 是 XState 的创建者。Stately 正在构建 Stately Studio，您可以在其中可视化您的应用程序逻辑并与您的整个团队协作。